...
#
# Generated by export_simulation on Fri Jul 22 10:08:31 CEST 2016
#
################################################################################
...
switch to the './linux_pl.sh' script.

./linux_pl.sh -reset_run
...
./linux_pl.sh -noclean_files

For more information on the script, please type './linux_pl.sh -help'.
