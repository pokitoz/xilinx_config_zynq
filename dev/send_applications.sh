...
#	rsync -av --exclude '*.svn' user@server:/my/dir .
	echo -e "$c_info Sending includes/ folder to $sshcommand:~/Desktop $c_default"
	sshpass -p "$env_sshpassword" scp -r includes/ $sshcommand:~/Desktop

	echo -e "$c_info Sending scripts to $sshcommand:~/Desktop $c_default"
